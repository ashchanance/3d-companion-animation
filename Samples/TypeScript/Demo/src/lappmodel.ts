...
export class LAppModel extends CubismUserModel {
  ...
  /**
   * Lip Sync procedural simulation control.
   */
  public startLipSyncSimulating(): void {
    if (this._wavFileHandler) {
      this._wavFileHandler.startSimulating();
    }
  }

  public stopLipSyncSimulating(): void {
    if (this._wavFileHandler) {
      this._wavFileHandler.stopSimulating();
    }
  }
